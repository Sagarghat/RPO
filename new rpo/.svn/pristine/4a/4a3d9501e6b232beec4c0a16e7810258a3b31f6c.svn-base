...
public class ReportsBarChartTemplates {
	...
	public String getRecruiterReports(Integer totalSubmissions, Integer totalRejections,String xHeading,String yHeading) {
		String base64Stream = null;
		File BarChart = null;
		ByteArrayOutputStream bos = null;
		try {
			...
			/* Step - 1: Define the data for the bar chart */
			DefaultCategoryDataset my_bar_chart_dataset = new DefaultCategoryDataset();
			my_bar_chart_dataset.addValue(totalSubmissions, xHeading, xHeading);
			my_bar_chart_dataset.addValue(totalRejections, yHeading, yHeading);

			/* Step -2:Define the JFreeChart object to create bar chart */
			JFreeChart BarChartObject = ChartFactory.createBarChart(xHeading+" Vs"+ yHeading, "", "Count",
					my_bar_chart_dataset, PlotOrientation.VERTICAL, true, true, false);
