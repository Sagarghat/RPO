...
public class DataBaseInitializer {
	...
	public void initDataBase() {
		  ...
		  userUser.addRole(Role.ADMIN); userUser.setRole("Admin"); List<User> list =
		  new ArrayList<User>(); list = userDao.findAll(); if (null == list ||
		  list.isEmpty()) { userUser.setStatus("Active"); this.userDao.save(userUser);
